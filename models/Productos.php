<?php
    class Producto extends Conectar{
        ...
        public function insert_producto($prod_nombre){
            ...
            $sql= "INSERT INTO tm_producto (prod_id, prod_nombre, fecha_crea, fecha_mod, fecha_elim, est) VALUES(NULL, ?, now(), NULL, NULL, 1);";
            $sql=$conectar->prepare($sql);
        ...
        public function update_producto($prod_id, $prod_nombre){
            ...
            $sql= "UPDATE tm_producto SET prod_nombre = ?, fecha_mod=now() WHERE prod_id = ?";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1,$prod_nombre);
